  ...
  return (
    <div className={`grid grid-cols-1 md:grid-cols-2 gap-4 ${className}`}>
      <div className="border border-neutral-light rounded p-3">
        ...
        <p className="text-sm text-neutral-medium">{picoData.population}</p>
      </div>
      
      <div className="border border-neutral-light rounded p-3">
        <h4 className="text-sm font-medium text-primary mb-1">Intervention</h4>
        <p className="text-sm text-neutral-medium">{picoData.intervention}</p>
      </div>
      
      <div className="border border-neutral-light rounded p-3">
        <h4 className="text-sm font-medium text-primary mb-1">Comparator</h4>
        <p className="text-sm text-neutral-medium">{picoData.comparator}</p>
      </div>
      
      <div className="border border-neutral-light rounded p-3">
        <h4 className="text-sm font-medium text-primary mb-1">Outcomes</h4>
        <p className="text-sm text-neutral-medium">{picoData.outcomes}</p>
      </div>
    </div>
  );
};
